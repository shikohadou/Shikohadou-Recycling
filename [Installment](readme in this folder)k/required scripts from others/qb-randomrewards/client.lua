...
RegisterNetEvent('angelicxs-randombox2:Notify', function(message, type)
	if Config.UseCustomNotify then
        TriggerEvent('angelicxs-randombox2:CustomNotify',message, type)
    ...
    if Config.PurchaseBox then
        ...
        while true do
            ...
            if Dist <= 50 and not PedSpawned then
                TriggerEvent('angelicxs-randombox2:SpawnNPC',Config.PurchaseBoxLocation,Config.NPC,Config.NPCScenario)
                PedSpawned = true
...
RegisterNetEvent('angelicxs-randombox2:SpawnNPC',function(coords,model,scenario)
            ...
            local ox_options = {
                {
                    ...
                    onSelect = function(entity)
                        TriggerServerEvent('angelicxs-randombox2:server:GetMoney', Config.Tier1Price)
                    end,
                }, {
                    icon = Config.ThirdEyeIcon,
                    ...
                    onSelect = function(entity)
                        TriggerServerEvent('angelicxs-randombox2:server:GetMoney', Config.Tier2Price)
                    end,
                }, {
                    icon = Config.ThirdEyeIcon,
                    ...
                    onSelect = function(entity)
                        TriggerServerEvent('angelicxs-randombox2:server:GetMoney', Config.Tier3Price)
                    end,
                }, {
                    icon = Config.ThirdEyeIcon,
                    ...
                    onSelect = function(entity)
                        TriggerServerEvent('angelicxs-randombox2:server:GetMoney', Config.Tier4Price)
                    end,
                }, {
                    icon = Config.ThirdEyeIcon,
                    ...
                    onSelect = function(entity)
                        TriggerServerEvent('angelicxs-randombox2:server:GetMoney', Config.Tier5Price)
                    end,
                }, 
            }
