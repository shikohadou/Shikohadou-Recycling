...
inside of the warehouses config files you`ll notice some items i havent included since there more for my own server...
 ...
 [recycling] = this is the house for all the warehouse scripts and configs, use as you want...		
  ...
  Lastly i would like to thank Jimmy, of Jixelpatterns for releasing jim-mining for free, iv managed to make a lovely modified version which i want to be part of your stuff, so ill be uploading my version and asking if you want to merge it?
  
  Kind Regards 
  
  Shiko
  
  Ps. Have a nice day, night or evening, no matter were you might be in this world, remember to stay hydrated!
