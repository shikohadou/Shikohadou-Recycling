...
local entranceTargetID = 'entranceMediumTwoTarget'
local isInsideEntranceZone = false
local entranceZone = nil

local exitTargetID = 'exitMediumTwoITarget'
...
local function DestroyPickupTarget()
  ...
  if Config.UseTarget then
	...
	--Warehouse MediumTwo
local function RegisterEntranceMediumTwoTarget()
  local coords = vector3(Config.MediumTwoOutsideLocation.x, Config.MediumTwoOutsideLocation.y, Config.MediumTwoOutsideLocation.z)

  if Config.UseTarget then
    entranceZone = exports['qb-target']:AddBoxZone(entranceTargetID, coords, 1, 4, {
      name = entranceTargetID,
      heading = 44.0,
      minZ = Config.MediumTwoOutsideLocation.z - 1.0,
      maxZ = Config.MediumTwoOutsideLocation.z + 2.0,
      debugPoly = false,
    }, {
      options = {
        {
          type = 'client',
          event = 'qb-recyclejob-MediumTwo:client:target:enterLocation',
          label = Lang:t("text.enter_MediumTwo_warehouse"),
        },
      },
      distance = 1.0
    })
    ...
    entranceZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        exports['qb-core']:DrawText(Lang:t("text.point_enter_MediumTwo_warehouse"), 'left')
      else
...
local function RegisterExitTarget()
  local coords = vector3(Config.MediumTwoInsideLocation.x, Config.MediumTwoInsideLocation.y, Config.MediumTwoInsideLocation.z)

  if Config.UseTarget then
    exitZone = exports['qb-target']:AddBoxZone(exitTargetID, coords, 1, 4, {
      name = exitTargetID,
      heading = 270,
      minZ = Config.MediumTwoInsideLocation.z - 1.0,
      maxZ = Config.MediumTwoInsideLocation.z + 2.0,
      debugPoly = false,
    }, {
      options = {
        {
          type = 'client',
          event = 'qb-recyclejob-MediumTwo:client:target:exitLocation',
          label = Lang:t("text.exit_MediumTwo_warehouse"),
        },
      },
      distance = 1.0
    })
    ...
    exitZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        exports['qb-core']:DrawText(Lang:t("text.point_exit_MediumTwo_warehouse"), 'left')
      else
        exports['qb-core']:HideText()
      end
...
local function RegisterDutyTarget()
  local coords = vector3(Config.MediumTwoDutyLocation.x, Config.MediumTwoDutyLocation.y, Config.MediumTwoDutyLocation.z)

  if Config.UseTarget then
    dutyZone = exports['qb-target']:AddBoxZone(dutyTargetID, coords, 1, 1, {
      name = dutyTargetID,
      heading = 270,
      minZ = Config.MediumTwoDutyLocation.z - 2.0,
      maxZ = Config.MediumTwoDutyLocation.z + 1.0,
      debugPoly = false,
    }, {
      options = {
        {
          type = 'client',
          event = 'qb-recyclejob-MediumTwo:client:target:toggleDuty',
...
local function RegisterDeliveyTarget()
  local coords = vector3(Config.MediumTwoDropLocation.x, Config.MediumTwoDropLocation.y, Config.MediumTwoDropLocation.z)

  if Config.UseTarget then
    deliveryZone = exports['qb-target']:AddBoxZone(deliveryTargetID, coords, 1, 1, {
      name = deliveryTargetID,
      heading = 270,
      minZ = Config.MediumTwoDropLocation.z - 2.0,
      maxZ = Config.MediumTwoDropLocation.z + 1.0,
      debugPoly = false,
    }, {
      options = {
        {
          type = 'client',
          event = 'qb-recyclejob-MediumTwo:client:target:dropPackage',
...
local function GetRandomPackage()
  packageCoords = Config.MediumTwoPickupLocations[math.random(1, #Config.MediumTwoPickupLocations)]
...
local function DropPackage()
  ...
  carryPackage = nil
	...
	--Warehouse MediumTwo Blip
local function SetLocationBlip()
  -- local RecycleBlip = AddBlipForCoord(Config.MediumTwoOutsideLocation.x, Config.MediumTwoOutsideLocation.y, Config.MediumTwoOutsideLocation.z)
...
local function buildInteriorDesign()
  for _, pickuploc in pairs(Config.MediumTwoPickupLocations) do
    local model = GetHashKey(Config.MediumTwoWarehouseObjects[math.random(1, #Config.MediumTwoWarehouseObjects)])
    RequestModel(model)
...
local function EnterLocation()
  ...
  SetEntityCoords(PlayerPedId(), Config.MediumTwoInsideLocation.x, Config.MediumTwoInsideLocation.y, Config.MediumTwoInsideLocation.z)
  buildInteriorDesign()
  DoScreenFadeIn(500)
...
local function ExitLocation()
  ...
  SetEntityCoords(PlayerPedId(), Config.MediumTwoOutsideLocation.x, Config.MediumTwoOutsideLocation.y, Config.MediumTwoOutsideLocation.z + 1)
  DoScreenFadeIn(500)
  ...
  if Config.UseTarget then
    pickupZone = exports['qb-target']:AddBoxZone(pickupTargetID, targetCoords, 4, 1.5, {
      ...
      options = {
        {
          type = 'client',
          event = 'qb-recyclejob-MediumTwo:client:target:pickupPackage',
...
RegisterNetEvent('qb-recyclejob-MediumTwo:client:target:enterLocation', function()
  EnterLocation()
end)

RegisterNetEvent('qb-recyclejob-MediumTwo:client:target:exitLocation', function()
  ExitLocation()
end)

RegisterNetEvent('qb-recyclejob-MediumTwo:client:target:toggleDuty', function()
  onDuty = not onDuty
  if onDuty then
...
RegisterNetEvent('qb-recyclejob-MediumTwo:client:target:pickupPackage', function()
...
RegisterNetEvent('qb-recyclejob-MediumTwo:client:target:dropPackage', function()
  ...
  QBCore.Functions.Progressbar('deliver_reycle_package',  Lang:t("text.unpacking_the_package"), Config.DeliveryActionDuration, false, true, {
      ...
      -- Done
      StopAnimTask(PlayerPedId(), 'mp_car_bomb', 'car_bomb_mechanic', 1.0)
      TriggerServerEvent('qb-mediumwarehouse2:server:getItemThreeFour')
      GetRandomPackage()
  end)
end)
...
CreateThread(function()
  ...
  SetLocationBlip()
  RegisterEntranceMediumTwoTarget()
    ...
    while true do
      ...
      if isInsideEntranceZone then
        ...
        if IsControlJustReleased(0, 38) then
          ...
          Wait(500)
          TriggerEvent('qb-recyclejob-MediumTwo:client:target:MediumTwoenterLocation')
          exports['qb-core']:HideText()
        end
      end
      ...
      if isInsideExitZone then
        ...
        if IsControlJustReleased(0, 38) then
          exports['qb-core']:KeyPressed()
          Wait(500)
          TriggerEvent('qb-recyclejob-MediumTwo:client:target:MediumTwoexitLocation')
          exports['qb-core']:HideText()
        end
      end
      ...
      if isInsideDutyZone then
        ...
        if IsControlJustReleased(0, 38) then
          exports['qb-core']:KeyPressed()
          Wait(500)
          TriggerEvent('qb-recyclejob-MediumTwo:client:target:toggleDuty')
          exports['qb-core']:HideText()
        end
      end
      ...
      if onDuty then
        if isInsidePickupZone and not carryPackage then
          ...
          if IsControlJustReleased(0, 38) then
            exports['qb-core']:KeyPressed()
            Wait(500)
            TriggerEvent('qb-recyclejob-MediumTwo:client:target:pickupPackage')
            exports['qb-core']:HideText()
          end
        ...
        if isInsideDeliveryZone and carryPackage then
          ...
          if IsControlJustReleased(0, 38) then
            exports['qb-core']:KeyPressed()
            Wait(500)
            TriggerEvent('qb-recyclejob-MediumTwo:client:target:dropPackage')
            exports['qb-core']:HideText()
          end
        end
      end
