local Translations = {
    ...
    text = {
        point_enter_SmallCar_warehouse= " Enter Small Car Warehouse",
        point_exit_SmallCar_warehouse = " Exit Small Car Warehouse",
				
		enter_SmallCar_warehouse= "Enter Small Car Warehouse",
        exit_SmallCar_warehouse= "Exit Small Car Warehouse",
