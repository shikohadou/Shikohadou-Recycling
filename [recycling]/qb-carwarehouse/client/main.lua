...
local function DrawPackageLocationBlip()
  ...
  DrawMarker(22, packageCoords.x, packageCoords.y, packageCoords.z + 1, 0, 0, 0, 180.0, 0, 0, 0.5, 0.5, 0.5, 255, 0, 0, 100, false, false, 4, true, nil, nil, false)
end
...
RegisterNetEvent('qb-recyclejob-Car:client:target:dropPackage', function()
  ...
  QBCore.Functions.Progressbar('deliver_reycle_package',  Lang:t("text.unpacking_the_package"), Config.DeliveryActionDuration, false, true, {
      ...
      -- Done
      StopAnimTask(PlayerPedId(), 'mp_car_bomb', 'car_bomb_mechanic', 1.0)
      TriggerServerEvent('qb-carwarehouse:server:getItemFive')
      GetRandomPackage()
  end)
end)
